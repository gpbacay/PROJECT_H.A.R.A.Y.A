...
__all__ = [
    'eLEXTYPE_PRIVATE14', 'DISPID_SWFEFormatTag',
    'SpNullPhoneConverter', 'STSF_CommonAppData',
    'SpeechGrammarWordType', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SGRsCount',
    'SAFTADPCM_22kHzMono', 'eLEXTYPE_PRIVATE11',
    'IInternetSecurityMgrSite', 'DISPID_SVESentenceBoundary',
    'DISPID_SABIMinNotification', 'DISPID_SLWType',
    'SpeechAudioFormatType', 'DISPID_SOTMatchesAttributes',
    'SpeechWordType', 'ISpRecoContext2', 'SGRSTTRule',
    'DISPID_SpeechPhoneConverter', 'SRADefaultToActive',
    'SPLOADOPTIONS', 'SPEI_WORD_BOUNDARY', 'SDTDisplayText',
    'SRSInactive', 'DISPID_SPRsItem', 'DISPID_SVSpeakStream',
    'SDTAll', 'DISPID_SVSpeak', 'SPRST_ACTIVE_ALWAYS',
    'SGDSActiveUserDelimited', 'DISPID_SVSCurrentStreamNumber',
    'eLEXTYPE_PRIVATE5', 'eLEXTYPE_PRIVATE12', 'DISPID_SRRTLength',
    'SPEI_TTS_PRIVATE', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechPhraseElement', 'STSF_FlagCreate',
    'DISPID_SPAsCount', 'ISpPhoneConverter', 'DISPID_SPIReplacements',
    'SAFT24kHz16BitMono', 'DISPID_SOTGetAttribute', 'SpeechRunState',
    'DISPID_SRSNumberOfActiveRules', 'SPSUnknown',
    'DISPID_SRSetPropertyString', 'eLEXTYPE_USER',
    'DISPID_SpeechAudioBufferInfo', 'ISpeechRecoResultTimes',
    'DISPID_SRCEPropertyStringChange', 'Speech_Max_Word_Length',
    'SPEI_REQUEST_UI', 'SPEI_TTS_BOOKMARK', 'SPVPRI_OVER',
    'SPLO_DYNAMIC', 'DISPID_SGRSTRule', 'DISPIDSPTSI_SelectionLength',
    'SPSEMANTICFORMAT', 'SpeechVoiceCategoryTTSRate', 'SBOPause',
    'SPPS_NotOverriden', 'SPDKL_CurrentConfig', 'SpeechLoadOption',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRCEFalseRecognition',
    'ISpeechPhraseAlternates', 'DISPID_SVSRunningState',
    'SP_VISEME_18', 'SDTAlternates', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SWFEChannels', 'SFTSREngine', 'SPRS_ACTIVE',
    'SPINTERFERENCE_LATENCY_WARNING', 'STCRemoteServer', 'SVP_12',
    'DISPID_SpeechVoice', 'ISpProperties', 'SAFT44kHz16BitMono',
    'STCAll', 'SPRECORESULTTIMES', 'SPRULE', 'DISPID_SRProfile',
    'DISPID_SMSAMMHandle', 'SVP_1', 'SAFT48kHz16BitStereo',
    'ISpeechRecoResult', 'SRAExport', 'SWTAdded', 'DISPID_SGRsItem',
    'SPPHRASEREPLACEMENT', 'DISPID_SPRText', 'DISPID_SRCESoundEnd',
    'SINoSignal', 'DISPID_SPRs_NewEnum',
    'SpeechRegistryLocalMachineRoot', '_SPAUDIOSTATE',
    'DISPID_SVSInputSentenceLength', 'SREStreamStart',
    'SpeechVoiceEvents', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SDKDeleteValue', 'DISPID_SPRulesCount',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT8kHz8BitMono',
    'DISPID_SLPPartOfSpeech', 'SVSFUnusedFlags',
    'SPEI_RECO_OTHER_CONTEXT', 'eLEXTYPE_PRIVATE15',
    'SAFT48kHz8BitMono', 'eLEXTYPE_PRIVATE2',
    'SpeechEngineProperties', 'ISpeechObjectTokens',
    'DISPID_SPIStartTime', 'ISpNotifySink', 'eLEXTYPE_RESERVED8',
    'SpeechTokenIdUserLexicon', 'DISPID_SASetState', 'SPWORD',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPEsItem',
    'SpNotifyTranslator', 'SSTTTextBuffer', 'SAFT8kHz16BitStereo',
    'DISPID_SLWsItem', 'DISPID_SRCBookmark', 'SAFTADPCM_8kHzMono',
    'ISpeechGrammarRuleStateTransition', 'SPBO_NONE', 'SPPS_Function',
    '_ISpeechRecoContextEvents', 'SDTReplacement',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechFormatType',
    'DISPID_SPEPronunciation', 'SPSERIALIZEDPHRASE',
    'DISPID_SpeechPhraseInfo', 'DISPID_SVSLastStreamNumberQueued',
    'SPPS_Verb', 'SINone', 'DISPID_SpeechVoiceEvent', 'SPSModifier',
    'SPVOICESTATUS', 'SpeechAllElements', 'SGDSActiveWithAutoPause',
    'SPBO_PAUSE', 'SVP_10', 'SpeechRecoContextState',
    'DISPID_SVGetAudioOutputs', 'SRAONone',
    'SpeechGrammarTagWildcard', 'ISpRecognizer2',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPERetainedSizeBytes',
    'SAFT16kHz8BitMono', 'SPAO_RETAIN_AUDIO', 'SLTApp',
    'SAFTCCITT_uLaw_8kHzMono', 'SSSPTRelativeToStart', 'SLTUser',
    'DISPID_SWFEBitsPerSample', 'SPCT_DICTATION',
    'SDA_One_Trailing_Space', 'SpFileStream',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRCResume',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SGRSTType', 'SP_VISEME_13',
    'SPDKL_CurrentUser', 'SVEPhoneme', 'DISPID_SGRSRule',
    'DISPID_SVEStreamStart', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVSFIsXML', 'SAFT11kHz16BitStereo',
    'SPTEXTSELECTIONINFO', 'ISpStream', 'SAFT22kHz8BitStereo',
    'DISPID_SWFESamplesPerSec', 'DISPID_SGRSTPropertyName',
    'SPWT_LEXICAL', 'ISpRecognizer3', 'ISpeechFileStream',
    'DISPID_SPRuleParent', 'DISPID_SGRSTWeight', 'SPAUDIOBUFFERINFO',
    'DISPID_SVEWord', 'ISpeechTextSelectionInformation',
    'SVSFParseSapi', 'DISPID_SRState', 'DISPID_SpeechMemoryStream',
    'SRERequestUI', 'SPFM_OPEN_READONLY', 'SPEI_END_SR_STREAM',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SAStatus',
    'DISPID_SPAPhraseInfo', 'DISPID_SVRate', 'DISPID_SGRAddState',
    'DISPID_SRCRetainedAudioFormat', 'SRCS_Disabled', 'ISpeechVoice',
    'SVP_13', 'SpeechPropertyAdaptationOn', 'SBONone',
    'SAFTNonStandardFormat', 'ISpResourceManager',
    'SPADAPTATIONRELEVANCE', 'ISpeechRecoGrammar',
    'IEnumSpObjectTokens', 'SVSFPurgeBeforeSpeak', 'SpeechRuleState',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechAudioFormat', 'DISPID_SPAStartElementInResult',
    'DISPIDSPTSI_ActiveLength', 'SPPS_RESERVED2', 'SPEI_VOICE_CHANGE',
    'SVSFDefault', 'DISPID_SRCEEnginePrivate', 'SVP_18',
    'ISpSerializeState', 'SRAInterpreter', 'SP_VISEME_10',
    'DISPID_SPEDisplayAttributes', 'SAFT24kHz8BitMono',
    'SAFT32kHz16BitStereo', 'SPPS_RESERVED4', 'SVP_0',
    'DISPID_SpeechRecognizerStatus', 'SPINTERFERENCE',
    'DISPID_SPPsItem', 'SGLexical', 'SAFT48kHz16BitMono',
    ...
    'SP_VISEME_20', 'eLEXTYPE_PRIVATE8', 'SAFT44kHz8BitStereo',
    ...
    'SpeechPropertyResponseSpeed', 'SGRSTTEpsilon', 'DISPID_SVResume',
    'DISPID_SRCERecognition', 'ISpeechDataKey',
    'SPINTERFERENCE_TOOLOUD', 'SRERecoOtherContext',
    'ISpeechGrammarRule', 'SPAR_High', 'DISPID_SVGetVoices',
    'SDKLCurrentConfig', 'SPWF_SRENGINE', 'DISPID_SPRuleConfidence',
    'SP_VISEME_2', 'DISPID_SBSFormat', 'SAFT22kHz8BitMono',
    'SpeechWordPronounceable', 'SPAO_NONE', 'ISpObjectToken',
    'SRARoot', 'SpeechAudioFormatGUIDText', 'SGPronounciation',
    'ISpRecoCategory', 'SPXRO_Alternates_SML', 'ISpGrammarBuilder',
    'DISPID_SRSetPropertyNumber', 'SREBookmark',
    'DISPID_SRCEAdaptation', 'DISPID_SOTsCount', 'DISPID_SGRsDynamic',
    'eLEXTYPE_RESERVED6', 'SpPhoneticAlphabetConverter',
    'SAFTCCITT_ALaw_44kHzMono', 'SPPS_LMA', 'DISPID_SPPName',
    'tagSPTEXTSELECTIONINFO', 'ISpeechObjectTokenCategory',
    'ISpVoice', 'SAFT11kHz8BitMono', 'ISpMMSysAudio',
    'DISPID_SRRTStreamTime', 'SPEI_TTS_AUDIO_LEVEL',
    'SPEI_SENTENCE_BOUNDARY', 'SPEVENTENUM',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SP_VISEME_15',
    'SAFT24kHz16BitStereo', 'SPWT_DISPLAY', 'DISPID_SWFEExtraData',
    'SPSInterjection', 'SRTSMLTimeout', 'ISpeechPhoneConverter',
    'DISPID_SVEBookmark', 'DISPID_SPCIdToPhone', 'DISPID_SRStatus',
    'SPAUDIOSTATE', 'SPSMF_SAPI_PROPERTIES', 'SVSFPersistXML',
    'SpeechPropertyHighConfidenceThreshold', 'Speech_Default_Weight',
    'SECFIgnoreKanaType', 'SPEI_PHRASE_START',
    'DISPID_SVSpeakCompleteEvent', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SPRuleName', 'SPEI_START_INPUT_STREAM', 'SVSFParseSsml',
    'SPFM_CREATE_ALWAYS', 'SpeechRuleAttributes', 'SPSLMA',
    'ISpNotifySource', 'SRCS_Enabled', 'DISPID_SPIEngineId',
    'Speech_Max_Pron_Length', 'SDKLLocalMachine', 'SP_VISEME_12',
    'SPPS_SuppressWord', 'ISpeechPhraseInfo', 'ISequentialStream',
    'SDTRule', 'DISPID_SPRsCount', 'SpUnCompressedLexicon',
    'SVEViseme', 'STCInprocServer', 'DISPID_SGRAttributes',
    'SpeechCategoryRecoProfiles', '__MIDL_IWinTypes_0009',
    'SRTStandard', 'SRAORetainAudio', 'SVP_2',
    'DISPID_SRGIsPronounceable', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechSpecialTransitionType', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SOTCategory', 'SAFTNoAssignedFormat',
    'DISPID_SRCESoundStart', 'SREStateChange', 'SPINTERFERENCE_NOISE',
    'DISPID_SRCRequestedUIType', 'SITooSlow', 'SSFMOpenForRead',
    ...
    'DISPID_SPEDisplayText', 'SpeechCategoryAudioOut', 'SP_VISEME_11',
    'SPBO_TIME_UNITS', 'SPCS_DISABLED', 'SASStop', 'SpMMAudioOut',
    ...
    'SPEI_START_SR_STREAM', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPRules_NewEnum', 'SVEPrivate', 'SPPHRASEPROPERTY',
    'DISPID_SVSLastResult', 'eLEXTYPE_MORPHOLOGY',
    'eWORDTYPE_DELETED', 'SPVPRI_NORMAL', 'SpeechTokenKeyAttributes',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_APP',
    'SSTTDictation', 'SpeechAudioVolume', 'SREHypothesis',
    'DISPID_SLPLangId', 'SECFDefault', 'SVEStartInputStream',
    'SpInprocRecognizer', 'DISPID_SPRulesItem',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPIAudioSizeTime',
    'SVSFIsNotXML', 'SpWaveFormatEx', 'DISPID_SPAsItem',
    'SAFT44kHz8BitMono', 'SPEVENT', 'SPPHRASE', 'SVF_Emphasis',
    'SpeechRecoEvents', 'SPCONTEXTSTATE', 'SPPS_Noun',
    'ISpeechRecoResultDispatch',
    'SpeechPropertyNormalConfidenceThreshold',
    'SREPropertyStringChange', 'SAFT44kHz16BitStereo',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRAudioInput', 'ISpShortcut',
    'DISPID_SPRuleNumberOfElements', 'SpeechDisplayAttributes',
    'SPRECOGNIZERSTATUS', 'SPSHT_EMAIL', 'DISPID_SRGReset',
    'SPWORDTYPE', 'SPGS_ENABLED', 'DISPID_SPERequiredConfidence',
    'SAFT16kHz16BitStereo', 'SPGS_DISABLED', 'SPEI_END_INPUT_STREAM',
    'SVP_16', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SREStreamEnd',
    'DISPID_SRGCmdLoadFromMemory', 'SREAllEvents', 'DISPID_SBSWrite',
    'SPWAVEFORMATTYPE', 'ISpeechVoiceStatus', 'tagSTATSTG', 'SVPOver',
    'ISpeechResourceLoader', 'SpMMAudioIn', 'eLEXTYPE_LETTERTOSOUND',
    'SRATopLevel', 'SGDSActive', 'DISPID_SpeechWaveFormatEx',
    'SpeechTokenShellFolder', 'DISPID_SAVolume', 'SSFMOpenReadWrite',
    'DISPID_SPISaveToMemory', 'DISPID_SPPsCount', 'SPRST_NUM_STATES',
    'SAFT8kHz16BitMono', 'SpeechCategoryPhoneConverters', 'SRTReSent',
    'DISPID_SFSClose', 'DISPID_SRRDiscardResultInfo',
    'SRSEIsSpeaking', 'DISPID_SABufferInfo', 'DISPID_SOTCSetId',
    'DISPID_SGRsAdd', 'DISPID_SVPause', 'DISPID_SPCPhoneToId',
    'SAFT48kHz8BitStereo', 'ISpRecognizer', 'SVESentenceBoundary',
    'DISPID_SpeechLexiconWord', 'SVP_9', 'eLEXTYPE_PRIVATE20',
    'DISPID_SRRRecoContext', 'ISpeechBaseStream',
    'DISPID_SLPPhoneIds', 'DISPID_SRGCmdSetRuleIdState',
    'SAFTADPCM_44kHzMono', 'DISPID_SGRSTsItem',
    'DISPID_SpeechLexiconProns', 'DISPID_SPIProperties',
    'SPPS_Noncontent', 'DISPID_SRCEPhraseStart',
    'Speech_StreamPos_Asap', 'SASClosed', 'eLEXTYPE_RESERVED4',
    'SpeechDiscardType', 'ISpeechGrammarRules', 'SpeechPartOfSpeech',
    'SECHighConfidence', 'SpAudioFormat', 'SPEI_RESERVED6',
    'DISPID_SRGDictationLoad', 'SDTProperty', 'ISpStreamFormat',
    'DISPID_SRRGetXMLResult', 'SPGRAMMARWORDTYPE', 'eWORDTYPE_ADDED',
    'SAFT32kHz8BitStereo', 'SAFT12kHz8BitStereo', 'SPSSuppressWord',
    'SVP_8', 'DISPID_SRCVoicePurgeEvent', 'SPEI_UNDEFINED',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SVSInputSentencePosition',
    'SPEI_SR_PRIVATE', 'SPSHT_OTHER', 'SPSFunction', 'SPFM_NUM_MODES',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SGRSTsCount',
    'SPFILEMODE', 'DISPID_SRCEAudioLevel', 'DISPID_SRCEEndStream',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRCPause', 'DISPID_SGRClear',
    'SPRST_INACTIVE', 'SpeechEngineConfidence',
    'SAFTGSM610_11kHzMono', 'SPSHORTCUTTYPE',
    'SGLexicalNoSpecialChars', 'ISpeechPhraseElement',
    'SPSNotOverriden', 'DISPID_SRCERequestUI',
    'DISPID_SRCRetainedAudio', 'DISPID_SLWs_NewEnum',
    'DISPID_SOTIsUISupported', 'DISPID_SAEventHandle',
    'DISPID_SLWLangId', 'SPAS_STOP', 'eLEXTYPE_PRIVATE19',
    'DISPID_SVVoice', 'LONG_PTR', 'SFTInput', 'SpMMAudioEnum',
    'SP_VISEME_16', 'ISpeechAudioFormat', 'SDKLDefaultLocation',
    'SAFT32kHz8BitMono', 'DISPID_SRCEStartStream',
    'DISPID_SRCEHypothesis', 'SAFTADPCM_8kHzStereo',
    'SpeechBookmarkOptions', 'SPRS_INACTIVE', 'SpeechTokenKeyFiles',
    'DISPID_SpeechLexicon', 'SVEWordBoundary', 'SPCATEGORYTYPE',
    'DISPID_SpeechPhraseReplacements', 'SDA_Two_Trailing_Spaces',
    'DISPID_SLWPronunciations', 'DISPID_SRSSupportedLanguages',
    'SRSInactiveWithPurge', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SP_VISEME_21', 'SVP_14', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SDKGetBinaryValue', 'SVSFNLPMask', 'SVSFVoiceMask',
    'SRAImport', 'eLEXTYPE_PRIVATE3', 'DISPID_SPPs_NewEnum',
    'SITooLoud', 'SPEI_RESERVED1', 'ISpObjectWithToken', 'SVP_20',
    'SAFT32kHz16BitMono', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRRTTickCount', 'DISPID_SPPEngineConfidence', 'SVP_3',
    'SpeechRecoProfileProperties', 'DISPID_SRGCmdLoadFromObject',
    'SVEEndInputStream', 'DISPID_SRIsShared', 'SVP_19',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPIElements', 'SpStream',
    'SpeechGrammarState', 'SDTLexicalForm', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SPRuleId', 'SPSMF_UPS', 'SREFalseRecognition',
    'DISPID_SMSGetData', 'DISPID_SpeechRecoResult',
    'SpObjectTokenCategory', 'SPBOOKMARKOPTIONS',
    'DISPID_SVGetAudioInputs', 'eLEXTYPE_PRIVATE13',
    'DISPID_SDKSetLongValue', 'ISpPhoneticAlphabetSelection',
    'SPLO_STATIC', 'DISPID_SPILanguageId', 'SLODynamic',
    'SRTExtendableParse', 'SAFTGSM610_22kHzMono',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SLPSymbolic', 'SPXRO_SML',
    'SPPS_Interjection', 'DISPID_SADefaultFormat',
    'DISPID_SRCCmdMaxAlternates',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SVPriority',
    'SDTPronunciation', 'SPFM_CREATE', 'SpCustomStream',
    'DISPID_SPEsCount', 'DISPIDSPTSI', 'DISPID_SAFGuid',
    'DISPID_SPCLangId', 'ISpeechPhraseAlternate',
    'SpeechAddRemoveWord', 'SPBO_AHEAD', 'SpSharedRecoContext',
    'SPEI_MAX_SR', 'SpeechRecognizerState', 'DISPID_SRCEInterference',
    'ISpeechPhraseReplacements', 'DISPID_SGRInitialState',
    'SP_VISEME_19', 'SRSEDone', 'DISPID_SRIsUISupported',
    'SPWORDPRONOUNCEABLE', 'STSF_AppData', 'SECFNoSpecialChars',
    'tagSPPROPERTYINFO', 'DISPID_SLGetWords', 'ISpeechLexicon',
    'SpCompressedLexicon', 'DISPID_SPEAudioSizeTime', 'SPAR_Unknown',
    'SRTAutopause', 'DISPID_SPIAudioStreamPosition',
    'SWPKnownWordPronounceable', 'SpeechLexiconType', 'DISPID_SOTId',
    'ISpNotifyTranslator', 'SpeechAudioState', 'DISPID_SRCEBookmark',
    'DISPID_SpeechGrammarRuleStateTransition', 'SP_VISEME_9',
    'DISPID_SMSALineId', 'SPEI_SOUND_END', 'DISPID_SRRecognizer',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPPValue', 'SECLowConfidence',
    'DISPID_SRSClsidEngine', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    '_RemotableHandle', 'DISPID_SVEventInterests',
    'DISPID_SRCCreateGrammar', 'DISPID_SPPConfidence',
    'DISPID_SGRAddResource', 'DISPID_SASFreeBufferSpace',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SOTs_NewEnum', 'SPPS_RESERVED3',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPBINARYGRAMMAR',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPEActualConfidence',
    'SpeechVisemeType', 'ISpEventSource', 'SVSFParseAutodetect',
    'SPDKL_LocalMachine', 'SECFEmulateResult',
    'SpeechEmulationCompareFlags', 'SGDSInactive',
    'ISpStreamFormatConverter', 'SpeechCategoryRecognizers',
    'SpResourceManager', 'SpeechMicTraining', 'ISpeechObjectToken',
    'DISPID_SpeechLexiconPronunciation', 'eLEXTYPE_PRIVATE7',
    'SPAS_CLOSED', 'SREInterference', 'SGSExclusive',
    'DISPID_SpeechFileStream', 'DISPID_SOTGetDescription',
    'SPPHRASEELEMENT', 'SPEI_MAX_TTS', 'SPEVENTSOURCEINFO',
    'SpeechRecognitionType', 'DISPID_SDKGetlongValue',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SLWWord',
    'DISPID_SGRSAddWordTransition', 'ISpRecoContext',
    'ISpeechPhraseProperties', 'SECFIgnoreCase',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPPId', 'SVP_15',
    'ISpXMLRecoResult', 'SECFIgnoreWidth', 'SpeechTokenValueCLSID',
    'DISPID_SpeechAudio', 'SpVoice', 'DISPID_SRRAudioFormat',
    'SPRST_ACTIVE', 'ISpeechMMSysAudio', 'ISpeechAudioBufferInfo',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechPhraseRules',
    'SPFM_OPEN_READWRITE', 'DISPID_SpeechDataKey', 'ISpLexicon',
    'SP_VISEME_4', 'SPEI_MIN_SR', 'SVEVoiceChange',
    'DISPID_SVGetProfiles', 'SINoise', 'SDA_No_Trailing_Space',
    'SPRULESTATE', 'SVP_11', 'SPXMLRESULTOPTIONS', 'SVP_6',
    'SSSPTRelativeToCurrentPosition',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVF_Stressed',
    'DISPID_SOTCEnumerateTokens', 'ISpPhraseAlt', 'SPEI_PHONEME',
    'SAFT11kHz16BitMono', 'SpeechCategoryVoices',
    'DISPID_SLGetGenerationChange',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SAFSetWaveFormatEx', 'SPRECOCONTEXTSTATUS', 'SAFTDefault',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRGId', 'SVF_None',
    'SpeechVisemeFeature', 'DISPID_SpeechGrammarRuleState',
    'SPPROPERTYINFO', 'SRTEmulated', 'DISPID_SVEViseme',
    'ISpRecoGrammar', 'SSFMCreate', 'DISPID_SOTsItem',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SVEAudioLevel',
    'DISPID_SDKSetBinaryValue', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SABufferNotifySize', 'DISPID_SGRSTransitions',
    'SP_VISEME_8', 'DISPID_SFSOpen', 'DISPID_SMSADeviceId',
    'DISPID_SMSSetData', 'SpStreamFormatConverter', 'ISpPhrase',
    'DISPID_SVSInputWordLength', 'DISPID_SOTDataKey',
    'eLEXTYPE_PRIVATE1', 'DISPID_SLWsCount',
    'SpeechPropertyResourceUsage', 'DISPID_SRRPhraseInfo',
    'SPSTREAMFORMATTYPE', 'eLEXTYPE_PRIVATE9', 'SpShortcut',
    'DISPID_SVAudioOutputStream', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechPhraseElements', 'DISPID_SASState',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPPChildren', 'SP_VISEME_14',
    'ISpPhoneticAlphabetConverter', 'SAFT12kHz16BitStereo',
    'SSSPTRelativeToEnd', 'DISPID_SRCreateRecoContext',
    'DISPID_SRRAudio', 'DISPID_SPARecoResult', 'DISPID_SPPParent',
    'SPSEMANTICERRORINFO', 'SVPNormal', 'SAFTADPCM_22kHzStereo',
    'SVSFNLPSpeakPunc', 'DISPID_SpeechGrammarRule', 'SVSFlagsAsync',
    'STCLocalServer', 'ISpeechPhraseElements', 'DISPID_SRGCommit',
    'IEnumString', 'ISpeechPhraseRule', 'SPSVerb', 'SRERecognition',
    'SpeechDataKeyLocation', 'SpeechTokenContext',
    'DISPID_SLPs_NewEnum', 'SVP_17',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SpeechCustomStream',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SGRName',
    'ISpeechRecognizer', 'DISPID_SPAs_NewEnum',
    'DISPID_SABIEventBias', 'SAFTADPCM_44kHzStereo',
    'SGRSTTDictation', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SpeechRecoResultTimes', 'SPAS_RUN', 'SREAdaptation',
    'DISPID_SLPsCount', 'SVEBookmark', 'SPCT_SLEEP',
    ...
    'DISPID_SpeechBaseStream', 'SAFTADPCM_11kHzMono', 'SVSFParseMask',
    'SpeechVoiceSpeakFlags', 'ISpRecoResult', 'SGSEnabled',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRRSpeakAudio',
    'WAVEFORMATEX', 'DISPID_SVEPhoneme', 'SPEI_MIN_TTS',
    'DISPID_SLPsItem', 'DISPID_SpeechPhraseReplacement',
    'SpeechCategoryAppLexicons', 'ISpeechRecoResult2',
    'eLEXTYPE_PRIVATE10', 'SREPropertyNumChange', 'SASPause',
    'SAFT16kHz8BitStereo', 'DISPID_SpeechPhraseProperty',
    'SPEI_SR_BOOKMARK', 'SpInProcRecoContext',
    'DISPID_SRGCmdSetRuleState', 'SPAR_Low', 'SPCT_COMMAND', 'SASRun',
    'SPEI_VISEME', 'SITooFast', 'SpeechAudioFormatGUIDWave',
    'ISpeechPhraseProperty', 'SDKLCurrentUser',
    'ISpeechGrammarRuleState', 'DISPID_SRCState',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SLAddPronunciation',
    'SSTTWildcard', 'DISPID_SASNonBlockingIO', 'SRESoundEnd',
    'DISPID_SRSCurrentStreamNumber', 'SPDKL_DefaultLocation',
    'SP_VISEME_5', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SBSRead', 'SAFTCCITT_uLaw_8kHzStereo', 'SGSDisabled',
    'SPCT_SUB_COMMAND', 'SREPrivate', 'DISPID_SPELexicalForm',
    'eLEXTYPE_RESERVED7', 'SAFT22kHz16BitStereo', 'SPEI_HYPOTHESIS',
    'DISPID_SRCVoice', 'SREPhraseStart', 'DISPID_SPIAudioSizeBytes',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpDataKey', 'SAFT24kHz8BitStereo',
    'DISPID_SAFGetWaveFormatEx', 'SpMemoryStream', 'SPGS_EXCLUSIVE',
    'eLEXTYPE_PRIVATE4', 'DISPID_SPIGetDisplayAttributes',
    'SP_VISEME_0', 'eLEXTYPE_PRIVATE18', 'DISPID_SGRsCommit',
    'DISPID_SOTRemoveStorageFileName', 'SAFTGSM610_8kHzMono',
    'DISPID_SABIBufferSize', 'DISPID_SGRs_NewEnum',
    'DISPID_SPRuleChildren', 'ISpeechAudioStatus',
    'DISPID_SOTCDefault', 'Speech_StreamPos_RealTime', 'SPVPRIORITY',
    'SVP_4', 'DISPID_SVVolume', 'SITooQuiet', 'DISPID_SOTDisplayUI',
    'DISPID_SVIsUISupported', 'ISpeechLexiconPronunciations',
    'SRSActive', 'SPCT_SUB_DICTATION', 'DISPID_SRRAlternates',
    'SAFTCCITT_uLaw_22kHzMono', 'SPEI_RECOGNITION',
    'SWPUnknownWordPronounceable', 'SVP_5', 'SRADynamic',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRGSetTextSelection',
    'SP_VISEME_6', 'eLEXTYPE_PRIVATE6',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPAUDIOSTATUS',
    'DISPID_SVEEnginePrivate', 'DISPID_SLPType', 'SPSHORTCUTPAIRLIST',
    'SPEI_INTERFERENCE', 'ISpRecoGrammar2', 'DISPID_SpeechRecognizer',
    'SAFT12kHz8BitMono', 'SSFMCreateForWrite',
    'DISPID_SRRSetTextFeedback', 'SAFT8kHz8BitStereo',
    'DISPID_SOTCId', 'DISPID_SWFEBlockAlign',
    'eLEXTYPE_USER_SHORTCUT', 'SVPAlert', 'DISPID_SRSAudioStatus',
    'SRSActiveAlways', 'SPPS_RESERVED1', 'SpPhraseInfoBuilder',
    'DISPID_SpeechPhraseAlternates', 'SP_VISEME_1',
    'DISPID_SDKDeleteKey', 'DISPID_SRCRecognizer',
    'DISPID_SPEAudioTimeOffset', 'SP_VISEME_3',
    'ISpeechPhraseReplacement', 'SPSNoun', 'SpeechInterference',
    'SPSHT_Unknown', 'SPAUDIOOPTIONS', 'SPWORDLIST',
    'SpeechRetainedAudioOptions', 'SPAS_PAUSE', 'ISpeechLexiconWord',
    'DISPID_SGRSTNextState', 'UINT_PTR', 'DISPID_SRGRecoContext',
    'ISpeechXMLRecoResult', 'ISpeechMemoryStream',
    'DISPID_SPPNumberOfElements', 'SGDisplay',
    'DISPID_SDKGetStringValue', 'SP_VISEME_7',
    'DISPID_SpeechVoiceStatus', 'SAFT22kHz16BitMono', 'SVEAllEvents',
    'SPSHORTCUTPAIR', 'SLOStatic', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFTText', 'SAFTCCITT_uLaw_44kHzMono', 'SAFT12kHz16BitMono',
    'DISPID_SVAlertBoundary', 'SpObjectToken', 'SPEI_ADAPTATION',
    'DISPID_SPIGetText', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPPFirstElement', 'ISpeechAudio', 'SPSHT_NotOverriden',
    'DISPID_SVAudioOutput', 'SPPS_Modifier',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechLexiconPronunciation',
    'SPDATAKEYLOCATION', 'SAFT11kHz8BitStereo', 'DISPID_SOTRemove',
    'DISPID_SRGetFormat', 'DISPID_SGRSTPropertyId',
    'SpSharedRecognizer', 'ISpObjectTokenCategory', 'DISPID_SAFType',
    'SPCS_ENABLED', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SVSVisemeId', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpeechWaveFormatEx', 'DISPID_SRSCurrentStreamPosition',
    'ISpeechLexiconWords', 'ISpeechRecoContext', 'DISPID_SPACommit',
    'SAFTExtendedAudioFormat', 'DISPID_SVEVoiceChange',
    'SpeechUserTraining', 'SpTextSelectionInformation',
    'DISPID_SVSLastBookmark', 'IStream', 'eLEXTYPE_PRIVATE17',
    ...
    'SPLEXICONTYPE', 'DISPID_SpeechPhraseProperties',
    'SPSERIALIZEDRESULT', 'DISPID_SGRSTPropertyValue',
    'SREAudioLevel', 'DISPID_SRGetRecognizers', 'SP_VISEME_17',
    'SpeechStreamSeekPositionType', 'SPWT_PRONUNCIATION',
    'DISPID_SRAudioInputStream', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPRDisplayAttributes', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SGRSTTWildcard', 'SpeechCategoryAudioIn', 'SpeechVoicePriority',
    'DISPID_SpeechLexiconWords', 'SRESoundStart',
    'DISPID_SDKEnumValues', 'DISPID_SpeechPhraseRule',
    'eLEXTYPE_RESERVED10', 'ISpEventSink', 'SPRECOSTATE',
    ...
    'SPPS_Unknown', 'SGRSTTWord', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechObjectTokens', 'DISPID_SpeechRecoResult2',
    'ISpeechRecognizerStatus', 'SPVISEMES',
    ...
    'SPGRAMMARSTATE', 'DISPIDSPRG', 'SPAR_Medium', 'DISPID_SVSkip',
    'ISpeechPhraseRules', 'DISPID_SRRTimes',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SVStatus',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPIRule',
    'DISPID_SOTCreateInstance', 'SAFTCCITT_ALaw_22kHzStereo',
    'SGRSTTTextBuffer', 'DISPID_SpeechObjectToken', 'SPWF_INPUT',
    'DISPID_SRGState', 'DISPID_SRCEventInterests', 'SPVPRI_ALERT',
    'eLEXTYPE_RESERVED9', 'SVP_21', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPEEngineConfidence', 'SPEI_RESERVED3',
    'DISPID_SGRSTText', 'DISPID_SRGRules', 'SWTDeleted', 'SVP_7',
    'SVEAudioLevel', 'SVSFIsFilename', 'DISPID_SBSSeek',
    'SPPARTOFSPEECH', 'SpeechAudioProperties',
    ...
    'SDA_Consume_Leading_Spaces', 'SPEI_RESERVED5',
    'DISPID_SRDisplayUI', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SGRId', 'SAFT16kHz16BitMono', 'SpLexicon', 'SDTAudio',
