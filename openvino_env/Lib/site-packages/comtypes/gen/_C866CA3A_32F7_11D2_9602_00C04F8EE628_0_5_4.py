...
__all__ = [
    ...
    'SPRST_ACTIVE', 'DISPID_SRSNumberOfActiveRules', 'SVF_None',
    'SREAllEvents', 'DISPID_SPIProperties', 'SAFT16kHz8BitStereo',
    'SRADefaultToActive', 'SPAUDIOOPTIONS', 'eLEXTYPE_RESERVED4',
    'ISpeechPhraseProperty', 'DISPID_SpeechFileStream',
    'SpeechCategoryRecoProfiles', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_SOUND_START', 'SPEI_RESERVED3', 'SBOPause',
    'DISPID_SOTCDefault', 'DISPID_SOTCreateInstance', 'DISPIDSPRG',
    'SRSInactiveWithPurge', 'SVEVoiceChange',
    'DISPID_SLPPartOfSpeech', 'SpeechRecognitionType', 'SVF_Stressed',
    'DISPID_SPRulesItem', 'SpeechWordType',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRSCurrentStreamNumber',
    'SREStreamEnd', 'DISPID_SDKSetStringValue',
    'SAFTNonStandardFormat', 'DISPID_SMSADeviceId', 'SPEI_UNDEFINED',
    'SPSEMANTICERRORINFO', 'ISpNotifySink', 'SPGS_DISABLED',
    'DISPID_SRCEPhraseStart', 'ISpeechRecoGrammar', 'SPEI_RESERVED2',
    'SVP_4', 'SpeechDictationTopicSpelling', 'SPFILEMODE',
    'DISPID_SOTCEnumerateTokens', 'SECFIgnoreWidth', 'SPEI_MIN_TTS',
    'DISPID_SPIEngineId', 'SAFT16kHz16BitMono', 'SRESoundStart',
    'SPEVENTENUM', 'DISPID_SRCRecognizer', 'SpMMAudioOut',
    'SpFileStream', 'SWPUnknownWordPronounceable',
    'DISPID_SRIsUISupported', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SMSSetData', 'SpeechVoiceSkipTypeSentence',
    'SpeechVoiceCategoryTTSRate', 'SPWORDPRONUNCIATION',
    'DISPID_SVVoice', 'SREPropertyNumChange', 'SAFT44kHz16BitMono',
    'SPAR_Low', 'eLEXTYPE_PRIVATE18', 'SPWT_PRONUNCIATION',
    'DISPID_SLWPronunciations', 'ISpeechAudioBufferInfo',
    'DISPID_SVGetAudioOutputs', 'DISPID_SpeechPhraseRules',
    'DISPID_SFSOpen', 'ISpeechWaveFormatEx', 'DISPID_SRSClsidEngine',
    'ISpeechPhraseRule', 'SPWT_DISPLAY', 'DISPID_SRSAudioStatus',
    ...
    'DISPID_SVSInputWordLength', 'SVSFUnusedFlags',
    'DISPID_SVSpeakCompleteEvent', 'SPRS_ACTIVE', 'SPWORDTYPE',
    'SpObjectTokenCategory', 'DISPID_SRGDictationSetState',
    'SPLO_STATIC', 'SVSFIsFilename', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPRuleChildren', 'SVSFNLPSpeakPunc', 'DISPID_SGRsAdd',
    'SpeechCategoryRecognizers', 'ISpeechGrammarRuleStateTransitions',
    'SpMMAudioIn', 'DISPID_SVVolume', 'eLEXTYPE_RESERVED8',
    'DISPID_SBSSeek', 'DISPID_SGRAddResource', 'SDTReplacement',
    'ISpeechLexiconPronunciations', 'ISpeechPhraseElement',
    'ISpPhrase', 'DISPID_SPRFirstElement',
    'DISPID_SASCurrentDevicePosition', 'SpSharedRecoContext',
    'DISPID_SRCEAdaptation', 'IInternetSecurityManager',
    'ISpRecoContext2', 'DISPID_SPIElements',
    'SpeechAudioFormatGUIDText', 'SAFT24kHz8BitMono', 'SSTTWildcard',
    'SpShortcut', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SRTEmulated', 'SPBOOKMARKOPTIONS', 'SPEVENT',
    ...
    'SPVPRI_OVER', 'SAFTCCITT_ALaw_8kHzStereo', 'SVEWordBoundary',
    'DISPID_SABIBufferSize', 'DISPID_SpeechWaveFormatEx',
    'SPVOICESTATUS', 'SRSInactive', 'SpStream', 'DISPID_SLPSymbolic',
    ...
    'SRTExtendableParse', 'eLEXTYPE_RESERVED7', 'SPRS_INACTIVE',
    'SPXRO_SML', 'SVP_9', 'DISPID_SMSGetData',
    'DISPID_SpeechPhraseBuilder', 'SAFT48kHz8BitStereo',
    'SPEI_TTS_BOOKMARK', 'SGDisplay', 'SpeechDataKeyLocation',
    'WAVEFORMATEX', 'SPEI_SR_PRIVATE', 'DISPID_SpeechLexiconWord',
    'SPFM_OPEN_READONLY', 'DISPID_SPPsCount',
    'DISPID_SRCEStartStream', 'SFTInput', 'DISPID_SGRsItem',
    'DISPID_SPAsCount', 'SPPHRASEELEMENT', 'SPSHORTCUTTYPE',
    'DISPID_SABIMinNotification', 'ISpeechXMLRecoResult', 'SPAS_RUN',
    'SECFEmulateResult', 'SpeechPropertyResponseSpeed',
    'DISPID_SVStatus', 'DISPID_SLWsItem', 'SPSHORTCUTPAIRLIST',
    'SpeechEngineConfidence', 'SAFT24kHz16BitMono', 'SVF_Emphasis',
    'ISpRecoGrammar2', 'SPBINARYGRAMMAR',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SAFType',
    'SpeechVisemeType', 'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSTText',
    'SpeechStreamFileMode', 'DISPID_SpeechXMLRecoResult', 'SASPause',
    'SpeechWordPronounceable', 'SAFT24kHz16BitStereo', 'SRTAutopause',
    'ISpRecognizer2', 'SAFT44kHz8BitStereo', 'SGDSInactive',
    'SPFM_OPEN_READWRITE', 'eLEXTYPE_PRIVATE9', 'eLEXTYPE_PRIVATE11',
    'DISPID_SLWLangId', 'DISPID_SAStatus', 'SAFT8kHz16BitStereo',
    'SPPS_Verb', 'DISPID_SOTCGetDataKey', 'DISPID_SRRTTickCount',
    'SpeechVoiceSpeakFlags', 'ISpeechFileStream',
    'DISPID_SRCEInterference', 'DISPID_SWFEFormatTag',
    'DISPID_SGRName', 'SRADynamic', 'DISPID_SPCPhoneToId', 'SDTAudio',
    ...
    'SpeechInterference', 'SVSFNLPMask', 'ISpStreamFormat',
    'DISPID_SPIGetText', 'eLEXTYPE_PRIVATE16', 'SWTDeleted',
    'DISPID_SpeechPhraseProperties', 'DISPID_SpeechPhraseElement',
    'SPEI_PHRASE_START', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRRTLength', 'SITooFast',
    'SpeechPropertyLowConfidenceThreshold', 'SPPHRASE',
    'SPEI_WORD_BOUNDARY', 'SAFT44kHz16BitStereo', 'SP_VISEME_16',
    'DISPID_SPRsItem', 'SPRECOSTATE', 'DISPID_SGRSTWeight',
    'ISpeechLexicon', 'SP_VISEME_15', 'DISPID_SPRuleNumberOfElements',
    'SPEI_END_SR_STREAM', 'SSSPTRelativeToStart',
    'DISPID_SVGetVoices', 'SASRun', 'DISPID_SpeechRecoResult2',
    'SAFT12kHz8BitMono', 'SPSERIALIZEDRESULT', 'SPSHT_OTHER',
    'DISPID_SLGetPronunciations', 'DISPID_SVESentenceBoundary',
    'SPDKL_CurrentUser', 'SRSEDone', 'ISpGrammarBuilder',
    'SP_VISEME_8', 'DISPID_SRGCmdLoadFromResource', 'SSFMOpenForRead',
    'DISPID_SGRSTPropertyId', 'UINT_PTR', 'SPINTERFERENCE_NONE',
    'DISPID_SFSClose', 'DISPID_SLPPhoneIds', 'SVP_8',
    'DISPID_SVSInputWordPosition', 'SVP_20', 'ISpeechCustomStream',
    'ISpeechPhraseReplacement', 'SWTAdded', 'Speech_Max_Pron_Length',
    ...
    'SpeechRuleState', 'SPGRAMMARSTATE', 'SAFTCCITT_ALaw_8kHzMono',
    'SVEPrivate', 'ISpeechRecoResult', 'DISPID_SOTMatchesAttributes',
    'SPAUDIOBUFFERINFO', 'SGLexical', 'DISPID_SGRSTsCount',
    'SRATopLevel', 'ISpeechPhraseAlternate', 'DISPID_SVPause',
    'SpeechCategoryAudioOut', 'DISPID_SASCurrentSeekPosition',
    'SP_VISEME_14', 'SpStreamFormatConverter',
    'DISPID_SPRuleEngineConfidence', 'SVP_11', 'DISPID_SRState',
    'DISPID_SDKCreateKey', 'SDA_No_Trailing_Space', 'SPSFunction',
    'SPAO_RETAIN_AUDIO', 'DISPID_SDKOpenKey', 'SPPROPERTYINFO',
    'SpeechFormatType', 'SAFT8kHz8BitMono', 'eLEXTYPE_PRIVATE13',
    'SRERecoOtherContext', 'SpSharedRecognizer', 'STCInprocServer',
    ...
    'eLEXTYPE_RESERVED9', 'SP_VISEME_3', 'DISPID_SGRSTRule',
    'SPLEXICONTYPE', 'SGRSTTRule', 'DISPID_SPEPronunciation',
    'STCInprocHandler', 'SREHypothesis', 'SPSMF_UPS',
    'DISPID_SGRSTType', 'STCRemoteServer',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPPS_NotOverriden',
    'SPPS_Modifier', 'DISPID_SRCEventInterests', 'SVEEndInputStream',
    'SECFIgnoreCase', 'SPEI_RESERVED6',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVGetProfiles',
    'eLEXTYPE_PRIVATE8', 'SPDATAKEYLOCATION', 'SpCompressedLexicon',
    'DISPID_SRGCmdLoadFromObject', 'SP_VISEME_2', 'ISpNotifySource',
    'DISPID_SPACommit', 'SPWORDLIST', 'SAFT32kHz16BitStereo',
    'SPEI_RESERVED5', 'SVPNormal', 'SWPKnownWordPronounceable',
    'SVP_0', 'DISPID_SLPsItem', 'DISPID_SOTDisplayUI',
    'SAFT24kHz8BitStereo', 'SPPHRASEREPLACEMENT',
    'ISpeechRecoResult2', 'SPTEXTSELECTIONINFO', 'SAFT32kHz16BitMono',
    'ISpeechTextSelectionInformation',
    'SpeechCategoryPhoneConverters', 'SVP_13',
    'DISPID_SWFESamplesPerSec', 'SVSFPersistXML', 'SGRSTTDictation',
    'SAFTGSM610_8kHzMono', 'DISPID_SRRSpeakAudio',
    'STSF_CommonAppData', 'SPCT_SLEEP', 'SVEAudioLevel',
    'DISPID_SPPsItem', 'SPINTERFERENCE_TOOQUIET', 'ISpStream',
    'SSFMCreateForWrite', 'SPINTERFERENCE_NOISE',
    'DISPID_SDKDeleteKey', 'SP_VISEME_10', 'SPPS_Noun',
    'SAFTADPCM_44kHzMono', 'DISPIDSPTSI_SelectionOffset', 'SpLexicon',
    'DISPID_SpeechPhraseElements', 'SAFTGSM610_11kHzMono',
    'DISPID_SDKEnumValues', 'DISPID_SpeechDataKey', 'DISPID_SRRAudio',
    ...
    'DISPID_SRStatus', 'SPVPRIORITY', 'DISPID_SVEEnginePrivate',
    'DISPID_SRSSupportedLanguages', 'SpeechVoiceEvents',
    'SpInProcRecoContext', 'DISPID_SPRules_NewEnum',
    'ISpeechRecoResultTimes', 'DISPID_SRCVoice', 'SPEI_PHONEME',
    ...
    'DISPID_SpeechVoiceEvent', 'DISPID_SRRPhraseInfo',
    'DISPID_SPILanguageId', 'DISPID_SVEViseme', 'SVP_21',
    'ISpRecoResult', 'SPEI_ADAPTATION', 'DISPID_SMSALineId',
    'SpObjectToken', 'SVP_18', 'SpTextSelectionInformation',
    'SAFTGSM610_22kHzMono', 'DISPID_SASetState', 'SP_VISEME_18',
    'SAFT12kHz16BitStereo', 'DISPID_SRCESoundStart',
    'SAFT11kHz16BitMono', 'Speech_Default_Weight', 'SSFMCreate',
    'ISequentialStream', 'SpPhoneConverter', 'SPAR_Unknown',
    'DISPID_SVSInputSentenceLength', 'DISPID_SVSVisemeId',
    'DISPID_SRGCmdLoadFromFile', 'SpeechTokenContext', 'STSF_AppData',
    'SPEI_REQUEST_UI', 'ISpeechPhraseProperties', 'SPWF_SRENGINE',
    'eLEXTYPE_PRIVATE2', 'Speech_StreamPos_RealTime',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SGRInitialState', 'SAFT32kHz8BitStereo', 'SSTTTextBuffer',
    'DISPID_SPISaveToMemory', 'eLEXTYPE_RESERVED10',
    'eLEXTYPE_PRIVATE3', 'eLEXTYPE_PRIVATE15', 'SAFTADPCM_8kHzMono',
    'SVP_3', 'SRAONone', 'DISPID_SRCEBookmark', 'SGRSTTTextBuffer',
    'DISPID_SpeechCustomStream', 'DISPID_SRCreateRecoContext',
    'DISPID_SPAsItem', 'eLEXTYPE_PRIVATE17',
    'DISPID_SGRSTPropertyValue', 'SpeechDiscardType',
    'SPEI_RESERVED1', 'SPSHT_Unknown', 'eLEXTYPE_PRIVATE7',
    'eLEXTYPE_PRIVATE4', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPPNumberOfElements', 'SpeechLexiconType',
    'IEnumSpObjectTokens', 'SPRULESTATE', 'SRSActiveAlways',
    'DISPID_SpeechVoiceStatus', 'SAFT8kHz8BitStereo',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPEDisplayAttributes', 'SPVISEMES', 'SVP_5',
    'SAFTADPCM_22kHzStereo', 'SVP_10', 'SVP_12',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechMMSysAudio', 'SREBookmark', 'DISPID_SVRate',
    'SpeechAudioProperties', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPSHT_NotOverriden', 'SREAudioLevel', 'SPXMLRESULTOPTIONS',
    'DISPID_SPEsItem', 'DISPID_SWFEBitsPerSample', 'ISpPhraseAlt',
    'DISPID_SPRuleParent', 'SPEI_VOICE_CHANGE',
    'DISPID_SLAddPronunciation', 'ISpEventSink', 'SRTReSent',
    'DISPID_SVEPhoneme', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SBSRead', '_ISpeechRecoContextEvents',
    ...
    'ISpeechRecoContext', 'SGSExclusive', 'DISPID_SRGRecoContext',
    'DISPID_SRGIsPronounceable', 'IStream',
    'IInternetSecurityMgrSite', 'SPSEMANTICFORMAT', 'SVP_15',
    'SPPHRASERULE', 'DISPID_SRCPause', 'SPPS_Noncontent',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPAs_NewEnum',
    'SpeechTokenKeyUI', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_START_SR_STREAM', 'SP_VISEME_11', 'SPSERIALIZEDPHRASE',
    'DISPID_SPCIdToPhone', 'SPSTREAMFORMATTYPE', 'SPPS_Interjection',
    'SPINTERFERENCE_TOOLOUD', 'SSTTDictation', 'ISpObjectToken',
    'SVP_14', 'SPGRAMMARWORDTYPE', 'SPBO_PAUSE',
    'SpeechAudioFormatType', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPRuleFirstElement', 'ISpeechAudio',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRRTimes',
    'DISPID_SLPs_NewEnum', 'SPAO_NONE', 'SAFT12kHz16BitMono',
    'SRSActive', 'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SGRClear',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpObjectWithToken', 'DISPID_SVEWord',
    'SPCS_ENABLED', 'DISPID_SpeechPhraseInfo',
    'DISPID_SREmulateRecognition', 'SPDKL_DefaultLocation',
    'DISPID_SPIReplacements', 'SpeechAddRemoveWord',
    'SAFTADPCM_8kHzStereo', 'SPRST_NUM_STATES',
    'DISPID_SDKGetBinaryValue', 'SDA_One_Trailing_Space',
    ...
    'ISpeechPhraseRules', 'SpNullPhoneConverter',
    'SpeechStreamSeekPositionType', 'DISPID_SRGDictationLoad',
    'DISPID_SVSLastResult', 'DISPID_SRCERecognitionForOtherContext',
    'ISpAudio', 'DISPID_SPPEngineConfidence',
    'SGDSActiveWithAutoPause', 'SBONone', 'ISpeechVoiceStatus',
    'SpMemoryStream', 'eWORDTYPE_ADDED', 'SPVPRI_ALERT',
    'SPEI_FALSE_RECOGNITION', 'SVPAlert', 'DISPID_SRGState',
    ...
    'SVEBookmark', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSInputSentencePosition', 'SAFTADPCM_22kHzMono',
    'SPRECOCONTEXTSTATUS', 'DISPID_SLAddPronunciationByPhoneIds',
    ...
    'SAFTADPCM_11kHzStereo', 'SPEI_MIN_SR', 'SpMMAudioEnum',
    'ISpeechAudioFormat', 'SRAORetainAudio', 'SPSHT_EMAIL',
    'SPDKL_LocalMachine', 'SVESentenceBoundary', 'DISPID_SLWWord',
    'SPEI_SR_AUDIO_LEVEL', 'tagSPTEXTSELECTIONINFO', 'SVSFParseMask',
    'DISPID_SGRsCount', 'DISPID_SpeechRecoResult',
    'DISPID_SpeechLexiconPronunciation', 'SpAudioFormat',
    'SFTSREngine', 'DISPID_SVAudioOutputStream',
    'DISPID_SOTIsUISupported', 'DISPID_SLGetGenerationChange',
    'DISPIDSPTSI_ActiveOffset', 'SPCT_DICTATION',
    'DISPID_SRCVoicePurgeEvent', 'SECHighConfidence',
    'DISPID_SOTsCount', 'SpeechRecoContextState', 'SRAExport',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SCSBaseStream',
    'eLEXTYPE_PRIVATE5', 'SVP_7', 'SpeechRegistryLocalMachineRoot',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRCResume', 'eLEXTYPE_PRIVATE19', 'SPXRO_Alternates_SML',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPRuleName',
    'eLEXTYPE_RESERVED6', 'SpUnCompressedLexicon',
    'SPRST_ACTIVE_ALWAYS', 'SVP_17', 'DISPID_SGRSAddRuleTransition',
    'ISpeechPhraseInfoBuilder', 'SITooSlow', 'DISPID_SOTId',
    'DISPID_SpeechPhraseReplacement', 'SAFT16kHz8BitMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPEI_MAX_TTS',
    'DISPID_SRRAlternates', 'DISPID_SOTGetStorageFileName',
    'SpWaveFormatEx', 'SPSSuppressWord', 'DISPID_SOTsItem',
    'DISPID_SOTGetDescription', 'DISPID_SRGCommit',
    'DISPID_SRCERequestUI', 'SpeechRunState', 'DISPID_SVEStreamEnd',
    'SREFalseRecognition', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SDKEnumKeys', 'DISPID_SPRNumberOfElements', 'SLODynamic',
    'DISPID_SpeechLexicon', 'SVSFlagsAsync', 'SP_VISEME_13',
    'ISpeechAudioStatus', 'SPPS_RESERVED1',
    'SpeechRecoProfileProperties', 'DISPID_SRCEEnginePrivate',
    'SPRECOGNIZERSTATUS', 'SpeechUserTraining',
    'DISPID_SVAlertBoundary', 'SpVoice', 'SRCS_Enabled', 'SPAS_STOP',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechRecognizer', 'SP_VISEME_9',
    'DISPID_SpeechRecoResultTimes', 'SAFT8kHz16BitMono',
    'SPEI_PROPERTY_NUM_CHANGE', 'SECNormalConfidence', 'SINoise',
    'ISpeechPhoneConverter', 'DISPID_SPRDisplayAttributes',
    'SREPrivate', 'ISpRecoCategory', 'SPEI_INTERFERENCE',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechTokenShellFolder',
    'ISpPhoneticAlphabetSelection', 'ISpeechObjectTokenCategory',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SVSLastBookmarkId',
    'SP_VISEME_20', 'SVSFIsNotXML', 'DISPID_SDKSetBinaryValue',
    'DISPID_SLPLangId', 'SECFIgnoreKanaType', 'DISPID_SWFEExtraData',
    'SAFTText', 'SpeechGrammarRuleStateTransitionType',
    'SECLowConfidence', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVGetAudioInputs', 'DISPID_SGRAddState',
    'DISPID_SRCCreateGrammar', 'DISPID_SPEsCount',
    'SAFT12kHz8BitStereo', 'SPRST_INACTIVE_WITH_PURGE',
    'SpeechPartOfSpeech', 'DISPID_SLGetWords', 'DISPID_SLWsCount',
    'SPRULE', 'DISPID_SpeechGrammarRules', 'SGPronounciation',
    'DISPID_SVWaitUntilDone', 'SGRSTTWildcard', 'SPCT_SUB_COMMAND',
    'DISPID_SAVolume', 'DISPID_SRCEHypothesis', 'SVSFParseSapi',
    'ISpVoice', 'SP_VISEME_4', 'DISPID_SRCBookmark',
    'DISPID_SPIAudioSizeTime', 'DISPID_SWFEChannels',
    'DISPID_SpeechRecoContextEvents', 'ISpeechPhraseReplacements',
    'STCAll', 'SGRSTTWord', 'SAFT48kHz16BitMono',
    'SPFM_CREATE_ALWAYS', 'SP_VISEME_19', 'SINoSignal',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPRsCount', 'SRCS_Disabled',
    'SPSUnknown', 'DISPID_SPERetainedStreamOffset', 'SPAR_High',
    'SPEI_HYPOTHESIS', 'ISpProperties', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPIAudioStreamPosition', 'ISpXMLRecoResult',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPPHRASEPROPERTY',
    'SpeechRuleAttributes', 'Speech_Max_Word_Length', 'SVPOver',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SPAStartElementInResult', 'SpeechTokenIdUserLexicon',
    'DISPID_SRGDictationUnload', 'SDTProperty',
    'SAFTGSM610_44kHzMono', 'SPEI_VISEME', 'SPEVENTSOURCEINFO',
    'DISPID_SGRsCommitAndSave', 'SPAUDIOSTATUS', 'DISPID_SRProfile',
    'SpeechTokenKeyFiles', 'SpeechAudioVolume',
    'SpeechDisplayAttributes', 'DISPID_SRCEPropertyStringChange',
    'SPWAVEFORMATTYPE', 'SpeechAudioState', 'DISPID_SPPs_NewEnum',
    'SpeechCategoryAppLexicons', 'STCLocalServer',
    'eWORDTYPE_DELETED', 'SDTLexicalForm', 'SPSNotOverriden',
    'DISPID_SPEAudioStreamOffset', 'ISpeechPhraseInfo',
    'DISPID_SLRemovePronunciation', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRIsShared', 'eLEXTYPE_APP', 'DISPID_SPPConfidence',
    'DISPID_SRSetPropertyString', 'DISPID_SGRAttributes',
    'ISpeechGrammarRule', 'DISPID_SpeechAudioStatus', 'SAFTDefault',
    'SREPropertyStringChange', 'DISPID_SpeechAudioFormat',
    'SVSFVoiceMask', 'SRSEIsSpeaking', 'SPPS_RESERVED2',
    'SAFT32kHz8BitMono', 'ISpRecoGrammar', 'ISpeechBaseStream',
    'DISPID_SOTs_NewEnum', 'DISPID_SRCESoundEnd', 'SPAS_PAUSE',
    'SpeechAllElements', 'SpeechPropertyAdaptationOn', 'ISpLexicon',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SAFGuid',
    'DISPID_SRRDiscardResultInfo', 'ISpRecognizer3',
    'SpeechCategoryAudioIn', 'SPCATEGORYTYPE',
    'ISpeechLexiconPronunciation', 'DISPID_SPPValue', 'SP_VISEME_6',
    'SPBO_TIME_UNITS', 'SVSFIsXML', 'SPEI_RECOGNITION', 'SPBO_NONE',
    'SITooLoud', 'ISpShortcut', 'LONG_PTR', 'SGSDisabled',
    'SRESoundEnd', 'DISPID_SPELexicalForm', 'DISPID_SABufferInfo',
    'DISPID_SPRText', 'SPFM_CREATE', 'DISPID_SASState',
    'SPPARTOFSPEECH', 'SVP_1', 'DISPIDSPTSI_ActiveLength',
    'ISpeechObjectToken', 'SVEStartInputStream', 'SpInprocRecognizer',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRsFindRule',
    'DISPID_SVSLastBookmark', 'SDKLCurrentConfig',
    'SGLexicalNoSpecialChars', 'DISPID_SPRulesCount', 'tagSTATSTG',
    'SPSVerb', 'DISPID_SPPName', 'SSSPTRelativeToEnd',
    'DISPID_SPCLangId', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SWFEBlockAlign', 'DISPID_SVEStreamStart', 'SPLOADOPTIONS',
    ...
    'SDTDisplayText', 'SAFT11kHz16BitStereo', 'eLEXTYPE_PRIVATE20',
    'SPEI_SOUND_END', 'SpeechGrammarState', '_ISpeechVoiceEvents',
    'SECFDefault', 'STSF_LocalAppData', 'DISPID_SGRSTNextState',
    'DISPID_SRGCmdSetRuleState',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpEventSource',
    'SPWF_INPUT', 'DISPID_SVEVoiceChange', '_SPAUDIOSTATE',
    'SVEAllEvents', 'SGSEnabled', 'DISPID_SRCState',
    'DISPID_SPEAudioTimeOffset', 'SP_VISEME_17',
    'DISPID_SMSAMMHandle', 'DISPID_SPIRetainedSizeBytes', 'SDTRule',
    'DISPID_SpeechLexiconWords', 'ISpeechPhraseAlternates',
    'DISPID_SRCRequestedUIType', 'SPWT_LEXICAL', 'DISPID_SpeechVoice',
    'DISPID_SRRTStreamTime', 'DISPID_SOTGetAttribute',
    'SAFTExtendedAudioFormat', 'SP_VISEME_12',
    'SpeechAudioFormatGUIDWave', 'DISPID_SpeechLexiconProns',
    'DISPID_SADefaultFormat', 'SpeechLoadOption', 'SPINTERFERENCE',
    'ISpNotifyTranslator', 'DISPID_SRCRetainedAudio',
    'DISPID_SAFGetWaveFormatEx', 'SASStop', 'ISpeechLexiconWords',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechObjectTokens',
    'SPPS_SuppressWord', 'SAFTNoAssignedFormat',
    'SpeechVisemeFeature', 'SPSLMA', 'SPEI_SR_BOOKMARK',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRRTOffsetFromStart',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVAudioOutput',
    'SGRSTTEpsilon', 'SLTUser', 'DISPID_SPIRule', 'DISPID_SGRSRule',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SGRsCommit', 'SLOStatic',
    'SpCustomStream', 'SPPS_Unknown', 'DISPID_SGRs_NewEnum',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SOTCId',
    'DISPID_SRCERecognizerStateChange', 'SSFMOpenReadWrite',
    'SRAImport', 'DISPID_SWFEAvgBytesPerSec', 'SPSModifier',
    'SREStateChange', 'ISpeechMMSysAudio', 'SAFT22kHz16BitStereo',
    'SpeechBookmarkOptions', 'SpeechRecoEvents',
    'DISPID_SPARecoResult', 'DISPID_SPRs_NewEnum', 'DISPID_SVSpeak',
    'ISpMMSysAudio', 'SPAR_Medium', 'DISPID_SRRAudioFormat', 'SINone',
    'DISPID_SGRSAddWordTransition', 'eLEXTYPE_PRIVATE6',
    'SDTAlternates', 'SPEI_TTS_PRIVATE', 'SVP_19',
    'SAFTCCITT_uLaw_44kHzMono', 'SDKLLocalMachine', 'SVSFDefault',
    'DISPID_SVSPhonemeId', 'ISpDataKey', 'SP_VISEME_21',
    'ISpeechObjectTokens', 'SpResourceManager', 'ISpPhoneConverter',
    'DISPID_SpeechAudio', 'SpeechMicTraining', 'SREAdaptation',
    'SPCT_COMMAND', 'DISPID_SRRSetTextFeedback',
    ...
    'DISPID_SpeechPhraseReplacements', 'DISPID_SPEAudioSizeBytes',
    'SAFT44kHz8BitMono', 'ISpRecognizer', 'SAFT22kHz8BitStereo',
    'SPSMF_SAPI_PROPERTIES', 'SpeechGrammarTagDictation',
    'SPINTERFERENCE_LATENCY_WARNING', 'SVP_2',
    'ISpeechRecognizerStatus', 'DISPID_SDKDeleteValue',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SGRId', 'DISPID_SVPriority',
    'DISPID_SRGetPropertyString', 'SP_VISEME_0',
    'SGDSActiveUserDelimited', 'DISPID_SAEventHandle',
    'SPDKL_CurrentConfig', 'SRERecognition', 'SGDSActive',
    ...
    'DISPID_SOTSetId', 'SPGS_ENABLED', 'SPCONTEXTSTATE', 'SITooQuiet',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SLGenerationId', 'DISPID_SGRSAddSpecialTransition',
    'SPWORD', 'SVP_6', 'DISPID_SpeechPhraseRule',
    'DISPID_SRGetFormat', 'SREStreamStart', 'SP_VISEME_7',
    'SDKLDefaultLocation', 'IEnumString',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPEActualConfidence',
    'SPSInterjection', 'DISPID_SLPsCount', 'DISPID_SVIsUISupported',
    'DISPID_SPERetainedSizeBytes', 'eLEXTYPE_PRIVATE10',
    'DISPID_SOTCategory', 'DISPID_SVEventInterests', 'SPLO_DYNAMIC',
    'DISPID_SRGId', 'ISpeechVoice', 'SASClosed', 'DISPID_SLWType',
    'SPVPRI_NORMAL', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechSpecialTransitionType', 'DISPID_SVSkip', 'SPPS_RESERVED3',
    'DISPID_SGRsDynamic', 'SpeechPropertyComplexResponseSpeed',
    'DISPIDSPTSI', 'SpeechGrammarWordType', 'SAFTADPCM_11kHzMono',
    'ISpeechRecognizer', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SLPType', 'DISPID_SpeechPhoneConverter', 'SVSFParseSsml',
    'DISPID_SRAudioInput', 'DISPID_SRSCurrentStreamPosition',
    'SPPS_RESERVED4', 'DISPID_SOTCSetId', 'DISPID_SRCERecognition',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SDKLCurrentUser', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechRecognizerState', 'SPAUDIOSTATE', 'DISPID_SGRSTransitions',
    'SVEPhoneme', 'DISPID_SRCCmdMaxAlternates', 'DISPID_SRGReset',
    'ISpeechLexiconWord', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'ISpeechGrammarRuleState', 'DISPID_SRGSetWordSequenceData',
    'SP_VISEME_5', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechRegistryUserRoot', 'eLEXTYPE_PRIVATE14',
    'ISpeechMemoryStream', 'SRAInterpreter', '_RemotableHandle',
    'DISPID_SPPChildren', 'DISPID_SBSWrite', 'DISPID_SPEs_NewEnum',
    'eLEXTYPE_USER', 'SPSHORTCUTPAIR', 'SPAS_CLOSED', 'SDTAll',
    'SRTSMLTimeout', 'DISPID_SpeechPhraseProperty',
    'SpeechVoicePriority', 'SPPS_Function', 'SPPS_LMA',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechPhraseElements',
    'ISpStreamFormatConverter', 'DISPID_SPRuleId',
    'DISPID_SRRecognizer', 'ISpSerializeState', 'SPSNoun',
    'SPEI_RECO_STATE_CHANGE', '__MIDL_IWinTypes_0009',
    'eLEXTYPE_PRIVATE12', 'SPEI_MAX_SR', 'SECFNoSpecialChars',
    'SVEViseme', 'SLTApp', 'SpeechPropertyResourceUsage',
    'SpNotifyTranslator', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCEPropertyNumberChange', 'ISpRecoContext',
    'DISPID_SPPId', 'DISPID_SPIAudioSizeBytes', 'SVP_16',
    'ISpeechGrammarRules', 'DISPID_SRGRules', 'DISPID_SVResume',
    'SAFT22kHz16BitMono', 'DISPID_SPPFirstElement', 'SPFM_NUM_MODES',
    'SPRST_INACTIVE', 'SPBO_AHEAD', 'SP_VISEME_1', 'ISpeechDataKey',
    'DISPID_SRCEEndStream', 'SpeechRetainedAudioOptions',
    'STSF_FlagCreate', 'SPCS_DISABLED'
]
